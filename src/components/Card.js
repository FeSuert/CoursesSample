...
const Card = ({ course_id, name, org, start_display, image, short_description, blocks_url}) => {
    ...
    return(
    <div className="h-full container mx-auto p-6 hover:shadow-2xl max-w-sm bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
        ...
        <div className="inset-x-0 bottom-0">
            ...
            <a href={blocks_url} className="inline-flex items-center py-1 px-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                Read more
            </a>
        </div>
    </div>
