        ...
        <nav role="navigation" className="bg-blue-700 py-2 md:py-4">
            <div className="container px-4 mx-auto md:flex md:items-center">
                ...
                <div className="md:flex flex-col md:flex-row md:ml-auto mt-3 md:mt-0">
                    ...
                    <a href="/" data-testid="login" className="p-2 lg:px-4 md:mx-2 text-white text-center border border-transparent rounded hover:bg-indigo-100 hover:text-indigo-700 transition-colors duration-300">Login</a>
                    <a href="/" data-testid="signup" className="p-2 lg:px-4 md:mx-2 text-white text-center border border-solid border-blue-600 rounded hover:border-blue-200  transition-colors duration-300 mt-1 md:mt-0 md:ml-1">Signup</a>
                </div>
            </div>
        </nav>
    )
